  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action = "<?php echo base_url('gallery/update')?>" method = "post" enctype = "multipart/form-data">
          <input type ="hidden" name = "gallery_id" value = "<?php echo $gallery->gallery_id?>">
          <div class = "form-group">
            <label>Title</label>
            <input type = "text" name = "title" class = "form-control" value = "<?php echo $gallery->gallery_title?>">
</div>
<div class = "form-group">
            <label>Slug</label>
...
<div class = "form-group">
            ...
            <textarea name = "description" class = "form-control"><?php echo $gallery->description?></textarea>
</div>
<div class = "form-group">
            <label>Image</label>
